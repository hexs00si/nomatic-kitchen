...
const HomeSectionHero = () => {
  ...
  // Video data - memoized to prevent re-renders
  const videos = useMemo(() => homeHeroData.videos, [])
      ...
      >
        ...
        <div className="flex items-end justify-between mb-4">
          ...
          <div className="max-w-3xl text-white">
            ...
            >
              {homeHeroData.heading.main}
              <br />
              {homeHeroData.heading.subtitle}              
            </motion.h1>
          </div>
          ...
          >
            <p className="text-sm lg:text-base leading-relaxed">
              {homeHeroData.description.right}
            </p>
          </motion.div>
        </div>
        ...
        <div className="flex items-start justify-between mt-1.5">
          ...
          >
            <p className="text-base md:text-base lg:text-lg text-white/80 leading-relaxed">
              {homeHeroData.description.bottom}
            </p>
          </motion.div>
